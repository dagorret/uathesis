...
% Set up some values.
\completetitle{Proyecto de Tésis}
\fullname{Carlos Martin Dagorret} % Grad college wants your full name here.
\degreename{}	% Title of your degree.

\begin{document}

% Set up the title page
\maketitlepage
{Facultad de Ciencias Económicas}	% Title of your department.
{2019}							
